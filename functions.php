<?php
	...
	function script_init() {
		if (!is_admin()) {
			...
			wp_enqueue_script( 'script', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.14.2/TweenMax.min.js', false, '1.14.2', true );
			wp_enqueue_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/1.3.0/jquery.scrollmagic.js', false, '1.3.0', true );
			wp_enqueue_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/1.3.0/jquery.scrollmagic.debug.js', false, '1.3.0', true );
		}
	}
